          ...
          <div className="text-center lg:pt-16 lg:max-w-[40%]">
            ...
            <div>
              <p className="mp:p-4 mp:text-base sm:p-8 sm:text-base md:text-2xl lg:p-0 lg:text-base lg:leading-relaxed lg:text-left xl:text-[20px]">
                Talent Propeller believes in honest, transparent advice. If your
                recruitment strategy isn’t producing candidates for you, we’ll
                tell you why – and create disruptive, innovative campaigns to
